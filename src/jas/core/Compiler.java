...
public class Compiler {
    ...
    public static Node compile(String exp) {
        ...
        exp = formatList(exp); // this has to happen before fOormatperation()
...
//        System.out.println(boldBlack("formatted input: ") + exp);
    ...
    public static String formatLiteral(String exp) {
        exp = exp.replace("'", "''");
        int i = 0;
        while (exp.contains("''")) {
    ...
    public static String formatList(String exp) {
        while (exp.contains("{")) {
    ...
    public static String replace(String exp, char open, char close, String open1, String close1) {
    ...
    public static String formatOperations(String exp) {
    ...
    public static boolean isUnformatted(String exp) {
     ...
     * @since May 16th
     */
    public static int[] innermostIndices(String exp, char open, char close) {
     ...
     */
    public static int[] operationIndices(String segment, int index) {
     ...
     * "-6" would become "(0-6)"
     */
    public static String formatCoefficients(String exp) {
        for (int i = 0; i < exp.length() - 1; i++) {
    ...
    public static String formatParenthesis(String exp) {
